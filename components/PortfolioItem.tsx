    ...
    >
      <div className="container-auto">
        <div className="lg:grid lg:grid-cols-12 lg:gap-4">
          ...
          >
            <AnimatedElement
              animationClass={`fade-9 ${isEven ? 'lg:fade-in-right' : 'lg:fade-in-left'}`}
            >
              <h4 className="text-[38px] uppercase mb-[10px] md:text-[45px] md:mb-[20px] font-bold leading-[38px] md:leading-[45px]">
                {title}
              </h4>
              <h5 className="italic text-[24px] mb-[10px] leading-[24px]">
                {description}
              </h5>
              <Button
          ...
          <div
            className={twMerge(
              isEven && 'lg:col-start-1 lg:m-0 lg:ml-auto',
              'row-start-1 lg:col-span-6',
            )}
          >
            <AnimatedElement
              animationClass={`fade-9 ${isEven ? 'lg:fade-in-left' : 'lg:fade-in-right'}`}
            >
              <Image
                src={imageSrc}
                height={imageHeight}
