...
export const Hero = () => {
  return (
    <section className="hero bg-blue-500 text-center md:text-left h-[420px] md:h-[765px] overflow-hidden relative bottom-clip md:bottom-clip-md lg:bottom-clip-lg">
      <div className="container-auto">
        <div className="grid grid-cols-12">
          <div className="col-span-12 lg:col-span-9 xl:col-span-7">
            <h1 className="animated text-[52px] text-white leading-[52px] md:leading-[110px] mb-[30px] pt-[30px] md:text-[110px] md:mb-[70px] md:pt-[70px] lg:mb-[70px] lg:pt-[120px] font-bold">
              Hi, I'm <span className="text-yellow-500">Perry</span>
            </h1>

            <h2 className="animated font-bold text-white leading-[27px] max-w-[375px] mx-auto md:text-[24px] md:leading-[36px] md:pr-[150px] md:max-w-none lg:pr-[190x] xl:pr-[150px] 2xl:pr-[210px]">
