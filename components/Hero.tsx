...
export const Hero = () => {
  return (
    <section
      data-testid="hero"
      className="hero print:hidden bg-blue-500 text-center md:text-left h-[420px] md:h-[765px] overflow-hidden relative bottom-clip md:bottom-clip-md lg:bottom-clip-lg"
    >
          ...
          <div className="col-span-12 lg:col-span-9 xl:col-span-7">
            ...
            <AnimatedElement animationClass="fade-9-delay-2">
              <h2
                ...
                className="animated font-bold text-white leading-[27px] max-w-[375px] mx-auto md:text-[24px] md:leading-[36px] md:pr-[150px] md:max-w-none lg:pr-[190px] xl:pr-[150px] 2xl:pr-[210px]"
              >
      ...
      >
        <span data-testid="scroll-down-link-sr" className="sr-only">
